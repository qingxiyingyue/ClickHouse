...
class Result(MetaClasses.Serializable):
    ...
    @classmethod
    def create_from_command_execution(cls, name, command, *args, **kwargs):
        """

        :param name: Check name
        :param command: shell command or python callable or list of shell commands or python callables
        :param workdir:
        :param with_log:
        :param fail_fast:
        :param args:
        ...
        with_log = kwargs.pop('with_log', False)
        fail_fast = kwargs.pop('fail_fast', True)
        workdir = kwargs.pop('workdir', True)
